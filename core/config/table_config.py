...
TABLE_FIELDS_CONFIG = {
    ...
    # 日线级别股票数据表（后复权，从30分钟数据聚合）
    'quant.stock_data_1_day_hfq_fields': [
        'date', 'code', 'open', 'close', 'high', 'low', 'volume', 'amount', 'turn'
    ],
    'quant.stock_data_1_day_hfq': {
        'date': str,
        'code': str,
        'open': float,
        'close': float,
    ...
    # 日线级别股票指标表（后复权）
    'quant.stock_indicators_1_day_hfq_fields': [
        'date', 'code', 'diff', 'dea', 'macd', 'k', 'd', 'j', 'cci', 'mfi',
        'ma3', 'ma5', 'ma10', 'ma20', 'ma30', 'ma60', 'ma90',
        'boll_upper', 'boll_middle', 'boll_lower'
    ],
    'quant.stock_indicators_1_day_hfq': {
        'date': str,
        'code': str,
        'diff': float,
        'dea': float,
